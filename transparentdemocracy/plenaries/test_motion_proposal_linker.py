...
class MotionProposalLinkerTest(unittest.TestCase):
    ...
    def test_link_motions_with_proposals__all_plenaries__not_throwing(self):
        ...
        self.assertLessEqual(len(link_problems), 79)
    ...
    def test_link_motions_with_proposals__ip_298x_html__links_to_correct_proposals(self):
        ...
        self.assertEqual(
            "3515/1-9", matching_proposal_discussion26.proposals[0].documents_reference)

        # Assert: link motions with proposals with the same main document number,
        # even if sub-documents are different:
        self.assertEqual(
            "3515/10", motion_group11.motions[0].documents_reference)

        self.assertEqual(["55_296_d26_p0"],
                         documents_reference_object_3515.proposal_ids)
    ...
    def test_link_motions_with_proposals__ip_296x_html(self):
        ...
        self.assertEqual(
            "3515/9", motion_group46.motions[0].documents_reference)
    ...
    def test_link_motions_with_proposals__ip_262x_html__links_to_correct_proposals(self):
        ...
        self.assertEqual(
            "3495/5", motion_group12.motions[0].documents_reference)
        self.assertEqual(
            "3495/5", motion_group12.motions[1].documents_reference)
        self.assertEqual(
            "3495/5", motion_group12.motions[2].documents_reference)

        self.assertEqual(["55_261_d22_p0"],
                         documents_reference_object_3495.proposal_ids)
    ...
    def test_link_motions_with_proposals__ip_226x_html__multiple_proposal_discussions(self):
        ...
        self.assertEqual(["55_222_d03", "55_223_d01", "55_224_d01"],
                         documents_reference_object_2931.proposal_discussion_ids)

        self.assertEqual(
            "2931/7", motion_group62.motions[0].documents_reference)
        self.assertEqual(
            "2931/7", motion_group62.motions[1].documents_reference)
        self.assertEqual(
            "2931/7", motion_group62.motions[2].documents_reference)
        self.assertEqual(
            "2931/7", motion_group62.motions[3].documents_reference)
